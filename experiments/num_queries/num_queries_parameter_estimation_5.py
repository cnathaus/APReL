...
def main():
    ...
    if not os.path.exists("experiment_plots/parameter_estimation_5"):
        os.makedirs("experiment_plots/parameter_estimation_5")
    if not os.path.exists("experiment_plots/parameter_estimation_5/num_queries"):
        os.makedirs("experiment_plots/parameter_estimation_5/num_queries")

    foldername = "experiment_plots/parameter_estimation_5/num_queries/"
    ...
    np.savetxt(
        foldername + "cos_sim_parameter_estimation_5.txt",
        data,
        header=header,
        delimiter="\t",
        fmt="%.4f",
    ...
    for i in range(len(mean)):
        ...
        # plt.show()
        plt.savefig(foldername + f"cos_sim_parameter_estimation_5_{i}.png", dpi=300)
